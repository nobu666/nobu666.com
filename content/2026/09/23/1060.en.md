...
Drift in what a note says can be fixed a few days late and still be fine. The missing safety rule wasn't drift in a note. It was on the machine, and this hook doesn't count it. Whether a deployed file matches its original doesn't need reading, just a comparison. That's the kind of job a machine can take, but I haven't added it yet.
